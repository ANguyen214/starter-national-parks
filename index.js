...
const submitHandler = (event) => {
    ...
    //One way to get form data.
    // const parkName = document.querySelector("#name-input").value;
    // console.log(parkName);

    //FormData is a built-in object that can automatically read data from form
    //and present it in an easy to use interface. 
    const formData = new FormData(event.target);

    //FormData has methods to work with form. 
    //Example of get()
...
//Adding even listener to see when DOM is loaded. 
//Will then invoke main() function.
